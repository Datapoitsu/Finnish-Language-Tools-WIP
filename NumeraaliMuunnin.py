...
PienetKertomat = ["kymmenen", "sata"] 
PienetKertomatPartitiivi = ["kymmenentä", "sataa"]
#Isojen kertomayksiköiden nimet.
IsotKertomatYksikko = ["tuhat", "miljoona", "milrjardi", "biljoona", "triljoona"] 
IsotKertomatPartitiivi = ["tuhatta", "miljoonaa", "milrjardia", "biljoonaa", "triljoonaa"]
...
#Uusi versio, kolmas kerta toden sanoo.
        ...
        for k in range(len(ArvoOsoittimet[i])):
            ...
            if  k + 1 < len(ArvoOsoittimet[i]) and ArvoOsoittimet[i][k] == "1": #yksittäinen isoKertoma
                ...
                if k < len(ArvoOsoittimet[i]) - 1:
                    numeraali += IsotKertomatPartitiivi[k]
            if i == 0:
                numeraali += " "
    numeraali += paate
    return numeraali
